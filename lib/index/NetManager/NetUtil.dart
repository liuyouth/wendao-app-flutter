...
//  }
  /// 请求准备 转换 Method 为 字符串
  Future<ResultI<T>> request<T>(Method method, String url, {dynamic params,dynamic queryParameters}) {
  ...
  Future<ResultI<T>> _netRequest<T>(String method, String url,
     ...
     // _netRequestBare(method,url,data: data,queryParameters: queryParameters,cancelToken: cancelToken,options: options);
